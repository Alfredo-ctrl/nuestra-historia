...
const FIRST_MEMORY = {
  image:
    "https://res.cloudinary.com/dbbdcxcvx/image/upload/v1770874152/IMG-20250803-WA0017_2_tu6d5l.jpg",
...
const SHOP_PHOTOS = [
  {
    id: "shop1",
    price: 5,
    url: "https://res.cloudinary.com/dbbdcxcvx/image/upload/v1771215657/WhatsApp_Image_2026-02-15_at_10.08.08_PM_wghi7u.jpg",
    title: "Mini Freddy 1",
  },
  {
    id: "shop2",
    price: 5,
    url: "https://res.cloudinary.com/dbbdcxcvx/image/upload/v1771215657/WhatsApp_Image_2026-02-15_at_10.10.08_PM_p4038w.jpg",
    title: "Mini Freddy 2",
  },
  {
    id: "shop3",
    price: 5,
    url: "https://res.cloudinary.com/dbbdcxcvx/image/upload/v1771215657/WhatsApp_Image_2026-02-15_at_10.11.40_PM_yqqasn.jpg",
    title: "Mini Freddy 3",
  },
  {
    id: "shop4",
    price: 5,
    url: "https://res.cloudinary.com/dbbdcxcvx/image/upload/v1771215657/WhatsApp_Image_2026-02-15_at_10.10.26_PM_ov0gqk.jpg",
    title: "Mini Freddy 4",
  },
  {
    id: "shop5",
    price: 5,
    url: "https://res.cloudinary.com/dbbdcxcvx/image/upload/v1771215656/WhatsApp_Image_2026-02-15_at_10.12.50_PM_m9gzfq.jpg",
    title: "Mini Freddy 5",
  },
  {
    id: "shop6",
    price: 5,
    url: "https://res.cloudinary.com/dbbdcxcvx/image/upload/v1771215656/WhatsApp_Image_2026-02-15_at_10.11.57_PM_d7vyxy.jpg",
    title: "Mini Freddy 6",
  },
  {
    id: "shop7",
    price: 5,
    url: "https://res.cloudinary.com/dbbdcxcvx/image/upload/v1771215656/WhatsApp_Image_2026-02-15_at_10.09.42_PM_rll549.jpg",
    title: "Mini Freddy 7",
  },
  {
    id: "shop8",
    price: 5,
    url: "https://res.cloudinary.com/dbbdcxcvx/image/upload/v1771215656/WhatsApp_Image_2026-02-15_at_10.12.29_PM_nkwpun.jpg",
    title: "Mini Freddy 8",
  },
  {
    id: "shop9",
    price: 5,
    url: "https://res.cloudinary.com/dbbdcxcvx/image/upload/v1771215656/WhatsApp_Image_2026-02-15_at_10.13.15_PM_sdd7c8.jpg",
    title: "Mini Freddy 9",
  },
  {
    id: "shop10",
    price: 5,
    url: "https://res.cloudinary.com/dbbdcxcvx/image/upload/v1771215656/WhatsApp_Image_2026-02-15_at_10.09.53_PM_j8vwhq.jpg",
    title: "Mini Freddy 10",
  },
  {
    id: "clue2-fake-1",
    price: 100,
    type: "card",
    title: "Tarjeta Misteriosa A",
    text: "en esta no hay nada, sigue probando",
  },
  {
    id: "clue2-fake-2",
    price: 100,
    type: "card",
    title: "Tarjeta Misteriosa B",
    text: "en esta no hay nada, sigue probando",
  },
  {
    id: "clue2-fake-3",
  ...
  },
  {
    ...
    price: 100,
    type: "card",
    title: "Tarjeta Misteriosa Final",
    text: "Parte del código encontrada: 2",
    codeDigit: "2",
    revealAfterDecoys: true,
  },
];

const SAFE_24_CODE = "2412";
const SAFE_24_STORAGE_KEY = "safe_2026_02_24_opened";
const SHOP_DECOY_IDS = [
  "clue2-fake-1",
  "clue2-fake-2",
  "clue2-fake-3",
  "clue2-fake-4",
];
const HOUSE_GAME_AVATAR_URL =
  "https://res.cloudinary.com/dbbdcxcvx/image/upload/v1772149704/image-removebg-preview_fqyyk5.png";
...
function loadGameState() {
  ...
  if (savedCoins !== null && !Number.isNaN(parseInt(savedCoins, 10)))
    gameCoins = parseInt(savedCoins, 10);
...
const GALLERY = [
  {
    ...
    text: "una de las primeras fotitos que tubimos juntos, fue el inicio de una muy gran y linda historia de amor <3",
    image:
      "https://res.cloudinary.com/dbbdcxcvx/image/upload/v1770871186/EDIT_20250819_193612_yrjdpr.jpg",
  },
  {
    id: "g2",
    title: "Risas",
    text: "no recuerdo mucho de esta foto pero no dudo que fue uno de los tantos momentos que fuimos felizes",
    image:
      "https://res.cloudinary.com/dbbdcxcvx/image/upload/v1770871187/IMG_20260119_152336_v8gyvs.jpg",
  },
  {
    id: "g3",
    title: "Juntos",
    text: "ahhh en galerias, gracias por recordarmelo bebe, gracias por acompañarme, lo aprecio demaciado <3",
    image:
      "https://res.cloudinary.com/dbbdcxcvx/image/upload/v1770871188/IMG_20260208_162233_olfn9q.jpg",
  },
  {
    id: "g4",
    title: "Recuerdos",
    text: "JSAJSJ el conejo sin cabeza, ese dia mientras me maquillabas no podia parar de no verte, encerio eres increiblemente hermosa",
    image:
      "https://res.cloudinary.com/dbbdcxcvx/image/upload/v1770871187/IMG_20251210_001810_039_w3b3p7.webp",
  },
  {
    id: "g5",
    title: "Aventuras",
    text: "JASJSJS, super lindo dia reciente que si no me equivoco vimos la empleada, que chi bebe, te encerrare para que no veas a nadie masss, eres miaaa",
    image:
      "https://res.cloudinary.com/dbbdcxcvx/image/upload/v1770871189/IMG_20260104_204724_ncuvpz.jpg",
  },
  {
    id: "g6",
    title: "Detalles",
    text: "JASJASJA, eramos ranitas bebeee, gracias por jugar juegos conmigo <3",
    image:
      "https://res.cloudinary.com/dbbdcxcvx/image/upload/v1770871187/2204056143_74452406864721_1761194147955_dwsa3w.png",
  },
  {
    id: "g7",
    title: "Especial",
    text: "amo esta foto, desde esos entonces sabia y estaba decidido en ser todo tu futuro <3",
    image:
      "https://res.cloudinary.com/dbbdcxcvx/image/upload/v1770871187/IMG_20251009_113213_378_zccllq.webp",
  },
  {
    id: "g8",
    title: "Inolvidable",
    text: "sinceramente no recuerdo mucho el contexto pero no dudo que estaba siendo feliz",
    image:
      "https://res.cloudinary.com/dbbdcxcvx/image/upload/v1770871187/IMG_20260119_152328_xcczlg.jpg",
  },
  {
    id: "g9",
    title: "Magia",
    text: "ahhhhh encerio eres hermosaaaaaa, pls besameee",
    image:
      "https://res.cloudinary.com/dbbdcxcvx/image/upload/v1770871188/IMG_20251031_142250_xowfat.jpg",
  },
  {
    id: "g10",
    title: "Felicidad",
    text: "unas de las primeras fotos donde saliamos los 2, amo cada parte de estos recuerdos y sus momentos",
    image:
      "https://res.cloudinary.com/dbbdcxcvx/image/upload/v1770871188/IMG-20250810-WA0060_dsdzw5.jpg",
  },
  {
    id: "g11",
    title: "Nosotros",
    text: "oficialmente siendo esposos robloxianos, proximamente en vida real cariño",
    image:
      "https://res.cloudinary.com/dbbdcxcvx/image/upload/v1770871187/2204056143_117167805081799_1767865820369_d108l6.png",
  },
  {
    id: "g12",
    title: "Viajes",
    text: "iuuu foto mia, en la vida avia mirado a alguien con tanto aprecio y amor, solo por ti y para ti puedo ser asi de feliz",
    image:
      "https://res.cloudinary.com/dbbdcxcvx/image/upload/v1770871188/IMG_20251119_140716_w0g5di.jpg",
  },
  {
    id: "g13",
    title: "Amor",
    text: "JAJAJAJAJ, foto toda watajai, pero lo que paso ese dia y el paso que tomaste tomandome de la mano, me hizo sentime mas seguro que te necesitaba en mi vida",
    image:
      "https://res.cloudinary.com/dbbdcxcvx/image/upload/v1770871189/IMG-20250815-WA0035_a3jsnn.jpg",
  },
  {
    id: "g14",
    title: "Arte",
    text: "me encanta esta foto, nos vemos super twins, ese dia te tome muchas fotos como gran admirador numero1 que soy",
    image:
      "https://res.cloudinary.com/dbbdcxcvx/image/upload/v1770871190/museo_nsyvu9.jpg",
  },
  {
    id: "g15",
    title: "Mundos",
    text: "AJSJASJAJ, tuyyo en minecraft, hay que jugar bebeeeee",
    image:
      "https://res.cloudinary.com/dbbdcxcvx/image/upload/v1770871190/Screenshot_20251007-212536.Minecraft_jqizii.png",
  },
  {
    id: "g16",
    title: "Cómplices",
    text: "En el kamoon AJASJAJ, fue un gran paso salir con mi hermana, desde alli descubri lo bien que te llevavas con ella y lo mucho que le caiste bien",
    image:
      "https://res.cloudinary.com/dbbdcxcvx/image/upload/v1770871190/IMG-20250928-WA0036_zhhz7a.jpg",
  },
  {
    id: "g17",
    title: "Locuras",
    text: "super insanooos, HAJJSJSA, rara vez tomo fotos pero ese dia me queria animar aunque sea un poco",
    image:
      "https://res.cloudinary.com/dbbdcxcvx/image/upload/v1770871191/Snapchat-407395229_gwvakj.jpg",
  },
  {
    id: "g18",
    title: "Miradas",
    text: "otra de las primeras fotitos, amo cada una de las fotos que tomas bebeee",
    image:
      "https://res.cloudinary.com/dbbdcxcvx/image/upload/v1770871189/IMG-20250821-WA0065_gcqpzp.jpg",
  },
  {
    id: "g19",
    title: "Contigo",
    text: "mis bebes juntoos, JSJAJSJSA, te amo bebee<3",
    image:
      "https://res.cloudinary.com/dbbdcxcvx/image/upload/v1770871190/IMG-20250927-WA0011_ixymcz.jpg",
  },
  {
    id: "g20",
    title: "Te quiero",
    text: "JASJASJJASJAJSAJ, nos veiamos superrrr",
    image:
      "https://res.cloudinary.com/dbbdcxcvx/image/upload/v1770871191/Snapchat-1540043468_ikubii.jpg",
  },
];
...
const FLOATING_MEMORIES = [
  {
    id: "f1",
    url: "https://res.cloudinary.com/dbbdcxcvx/image/upload/v1770871186/EDIT_20250819_193612_yrjdpr.jpg",
    text: "una de las primeras fotitos que tubimos juntos, fue el inicio de una muy gran y linda historia de amor <3",
    title: "Nuestra Historia",
  },
  {
    id: "f2",
    url: "https://res.cloudinary.com/dbbdcxcvx/image/upload/v1770871187/IMG_20260119_152336_v8gyvs.jpg",
    text: "no recuerdo mucho de esta foto pero no dudo que fue uno de los tantos momentos que fuimos felizes",
    title: "Risas",
  },
  {
    id: "f3",
    url: "https://res.cloudinary.com/dbbdcxcvx/image/upload/v1770871188/IMG_20260208_162233_olfn9q.jpg",
    text: "ahhh en galerias, gracias por recordarmelo bebe, gracias por acompañarme, lo aprecio demaciado <3",
    title: "Juntos",
  },
  {
    id: "f4",
    url: "https://res.cloudinary.com/dbbdcxcvx/image/upload/v1770871187/IMG_20251210_001810_039_w3b3p7.webp",
    text: "JSAJSJ el conejo sin cabeza, ese dia mientras me maquillabas no podia parar de no verte, encerio eres increiblemente hermosa",
    title: "Recuerdos",
  },
  {
    id: "f5",
    url: "https://res.cloudinary.com/dbbdcxcvx/image/upload/v1770871189/IMG_20260104_204724_ncuvpz.jpg",
    text: "JASJSJS, super lindo dia reciente que si no me equivoco vimos la empleada, que chi bebe, te encerrare para que no veas a nadie masss, eres miaaa",
    title: "Aventuras",
  },
  {
    id: "f6",
    url: "https://res.cloudinary.com/dbbdcxcvx/image/upload/v1770871187/2204056143_74452406864721_1761194147955_dwsa3w.png",
    text: "JASJASJA, eramos ranitas bebeee, gracias por jugar juegos conmigo <3",
    title: "Detalles",
  },
  {
    id: "f7",
    url: "https://res.cloudinary.com/dbbdcxcvx/image/upload/v1770871187/IMG_20251009_113213_378_zccllq.webp",
    text: "amo esta foto, desde esos entonces sabia y estaba decidido en ser todo tu futuro <3",
    title: "Especial",
  },
  {
    id: "f8",
    url: "https://res.cloudinary.com/dbbdcxcvx/image/upload/v1770871187/IMG_20260119_152328_xcczlg.jpg",
    text: "sinceramente no recuerdo mucho el contexto pero no dudo que estaba siendo feliz",
    title: "Inolvidable",
  },
  {
    id: "f9",
    url: "https://res.cloudinary.com/dbbdcxcvx/image/upload/v1770871188/IMG_20251031_142250_xowfat.jpg",
    text: "ahhhhh encerio eres hermosaaaaaa, pls besameee",
    title: "Magia",
  },
  {
    id: "f10",
    url: "https://res.cloudinary.com/dbbdcxcvx/image/upload/v1770871188/IMG-20250810-WA0060_dsdzw5.jpg",
    text: "unas de las primeras fotos donde saliamos los 2, amo cada parte de estos recuerdos y sus momentos",
    title: "Felicidad",
  },
  {
    id: "f11",
    url: "https://res.cloudinary.com/dbbdcxcvx/image/upload/v1770871187/2204056143_117167805081799_1767865820369_d108l6.png",
    text: "oficialmente siendo esposos robloxianos, proximamente en vida real cariño",
    title: "Nosotros",
  },
  {
    id: "f12",
    url: "https://res.cloudinary.com/dbbdcxcvx/image/upload/v1770871188/IMG_20251119_140716_w0g5di.jpg",
    text: "iuuu foto mia, en la vida avia mirado a alguien con tanto aprecio y amor, solo por ti y para ti puedo ser asi de feliz",
    title: "Viajes",
  },
  {
    id: "f13",
    url: "https://res.cloudinary.com/dbbdcxcvx/image/upload/v1770871189/IMG-20250815-WA0035_a3jsnn.jpg",
    text: "JAJAJAJAJ, foto toda watajai, pero lo que paso ese dia y el paso que tomaste tomandome de la mano, me hizo sentime mas seguro que te necesitaba en mi vida",
    title: "Amor",
  },
  {
    id: "f14",
    url: "https://res.cloudinary.com/dbbdcxcvx/image/upload/v1770871190/museo_nsyvu9.jpg",
    text: "me encanta esta foto, nos vemos super twins, ese dia te tome muchas fotos como gran admirador numero1 que soy",
    title: "Arte",
  },
  {
    id: "f15",
    url: "https://res.cloudinary.com/dbbdcxcvx/image/upload/v1770871190/Screenshot_20251007-212536.Minecraft_jqizii.png",
    text: "AJSJASJAJ, tuyyo en minecraft, hay que jugar bebeeeee",
    title: "Mundos",
  },
  {
    id: "f16",
    url: "https://res.cloudinary.com/dbbdcxcvx/image/upload/v1770871190/IMG-20250928-WA0036_zhhz7a.jpg",
    text: "En el kamoon AJASJAJ, fue un gran paso salir con mi hermana, desde alli descubri lo bien que te llevavas con ella y lo mucho que le caiste bien",
    title: "Cómplices",
  },
  {
    id: "f17",
    url: "https://res.cloudinary.com/dbbdcxcvx/image/upload/v1770871191/Snapchat-407395229_gwvakj.jpg",
    text: "super insanooos, HAJJSJSA, rara vez tomo fotos pero ese dia me queria animar aunque sea un poco",
    title: "Locuras",
  },
  {
    id: "f18",
    url: "https://res.cloudinary.com/dbbdcxcvx/image/upload/v1770871189/IMG-20250821-WA0065_gcqpzp.jpg",
    text: "otra de las primeras fotitos, amo cada una de las fotos que tomas bebeee",
    title: "Miradas",
  },
  {
    id: "f19",
    url: "https://res.cloudinary.com/dbbdcxcvx/image/upload/v1770871190/IMG-20250927-WA0011_ixymcz.jpg",
    text: "mis bebes juntoos, JSJAJSJSA, te amo bebee<3",
    title: "Contigo",
  },
  {
    id: "f20",
    url: "https://res.cloudinary.com/dbbdcxcvx/image/upload/v1770871191/Snapchat-1540043468_ikubii.jpg",
    text: "JASJASJJASJAJSAJ, nos veiamos superrrr",
    title: "Te quiero",
  },
];
...
function createMemory(memoryData) {
  const { date, type, title, text, media, special, hint, hintMedia } =
    memoryData;
...
function showQuestSequence() {
  ...
  if (!overlay) {
    ...
    const closeOverlay = () =>
      overlay.classList.remove("is-open", "show-sheet");
...
function injectBookSecretClues(text) {
  ...
  clues.forEach(({ word, number }) => {
    ...
    if (rx.test(updated)) {
      updated = updated.replace(
        rx,
        `$1<span class="book-secret-clue" aria-hidden="true">${number}</span>`,
      );
    } else {
  ...
  if (missing.length) {
    const extraWords = missing
      .map(
        ({ word, number }) =>
          `${word}<span class="book-secret-clue" aria-hidden="true">${number}</span>`,
      )
      .join(" ");
    updated += `\n\nPista: ${extraWords}.`;
  }
...
function getHouseGameImagePool() {
  ...
  const floating = Array.isArray(FLOATING_MEMORIES)
    ? FLOATING_MEMORIES.map((f) => f.url)
    : [];
...
function renderHouseMysteryMemory(container, memory) {
    ...
    <div class="house-game-wrap">
      ...
      <div class="house-game-stage">
        ...
        <div class="house-game-ui">
          <div class="house-game-chip house-game-chip--obj">\u{1F3AF} Busca fotos y números ocultos</div>
          <div class="house-game-chip">\u{1F579}\u{FE0F} WASD / Flechas</div>
          <div class="house-game-chip house-game-counter" id="house-game-counter">\u{1F4F7} 0 / 0</div>
          <button class="house-game-chip house-game-action" id="house-game-inspect">\u{1F526} Inspeccionar</button>
        </div>
      </div>
  ...
  const counterEl = container.querySelector("#house-game-counter");
  ...
  resizeCanvas();
  const _hgResize = () => resizeCanvas();
  window.addEventListener("resize", _hgResize);
  ...
  const rooms = [
    { x: 80, y: 100, w: 700, h: 500, n: "Sala", floor: "#1a1e2a" },
    { x: 860, y: 100, w: 640, h: 460, n: "Comedor", floor: "#1c1f28" },
    { x: 1580, y: 100, w: 580, h: 460, n: "Cocina", floor: "#1e2028" },
    { x: 2240, y: 100, w: 520, h: 460, n: "Ba\u00F1o", floor: "#18202e" },
    { x: 200, y: 740, w: 640, h: 500, n: "Pasillo", floor: "#161a24" },
    { x: 920, y: 700, w: 720, h: 540, n: "Habitaci\u00F3n", floor: "#1d1b28" },
    { x: 1720, y: 700, w: 600, h: 540, n: "Habitaci\u00F3n 2", floor: "#1b1924" },
    { x: 2400, y: 700, w: 500, h: 540, n: "Closet", floor: "#1a1826" },
    { x: 500, y: 1400, w: 900, h: 480, n: "S\u00F3tano", floor: "#12141c" },
    { x: 1500, y: 1400, w: 800, h: 480, n: "Bodega", floor: "#141620" },
  ];

  const corridors = [
    { x: 740, y: 250, w: 120, h: 60 },
    { x: 1460, y: 260, w: 120, h: 60 },
    { x: 2120, y: 260, w: 120, h: 60 },
    { x: 350, y: 580, w: 70, h: 160 },
    { x: 1000, y: 520, w: 70, h: 180 },
    { x: 1700, y: 520, w: 70, h: 180 },
    { x: 800, y: 680, w: 120, h: 60 },
    { x: 1600, y: 900, w: 120, h: 60 },
    { x: 2280, y: 900, w: 120, h: 60 },
    { x: 700, y: 1220, w: 70, h: 180 },
    { x: 1360, y: 1560, w: 140, h: 60 },
    { x: 1800, y: 1200, w: 70, h: 200 },
  ];

  const furniture = [];
  rooms.forEach((r) => {
    furniture.push({ x: r.x + 20, y: r.y + 30, w: 70, h: 120, type: "wardrobe" });
    furniture.push({ x: r.x + r.w / 2 - 50, y: r.y + r.h / 2 - 25, w: 100, h: 50, type: "table" });
    furniture.push({ x: r.x + r.w - 100, y: r.y + 20, w: 80, h: 30, type: "shelf" });
    if (r.n.includes("Habitaci") || r.n === "Sala") {
      furniture.push({ x: r.x + r.w / 2 - 80, y: r.y + r.h - 90, w: 160, h: 60, type: "bed" });
    }
    furniture.push({ x: r.x + r.w - 45, y: r.y + 70, w: 30, h: 130, type: "bookshelf" });
    furniture.push({ x: r.x + r.w / 2 + 60, y: r.y + r.h / 2 + 30, w: 28, h: 28, type: "chair" });
  });

  const lamps = [
    { x: 430, y: 300, r: 200, flicker: 0 }, { x: 1180, y: 280, r: 180, flicker: 0 },
    { x: 1870, y: 280, r: 170, flicker: 0 }, { x: 2500, y: 280, r: 160, flicker: 0 },
    { x: 520, y: 960, r: 190, flicker: 0 }, { x: 1280, y: 940, r: 200, flicker: 0 },
    { x: 2020, y: 940, r: 180, flicker: 0 }, { x: 2650, y: 940, r: 160, flicker: 0 },
    { x: 950, y: 1620, r: 220, flicker: 0 }, { x: 1900, y: 1620, r: 200, flicker: 0 },
  ];
  ...
  for (let i = 0; i < 120; i++) {
    dustParticles.push({
      ...
      size: 1 + Math.random() * 2.5, speed: 4 + Math.random() * 10,
      alpha: 0.1 + Math.random() * 0.25, drift: (Math.random() - 0.5) * 8,
    });
  }
  ...
  rooms.forEach((r) => {
    for (let i = 0; i < 4; i++) {
      photoSpots.push({
        x: r.x + 110 + (i % 2) * (r.w * 0.4),
        y: r.y + 70 + Math.floor(i / 2) * (r.h * 0.35),
      });
    }
  });
  ...
  const photos = photoSpots.slice(0, imagePool.length).map((s, i) => ({
    id: "hg_" + i, x: s.x, y: s.y, w: 110, h: 80,
    url: imagePool[i], img: null, found: false, clue: null,
    glowPhase: Math.random() * Math.PI * 2,
  }));
  if (photos[5]) photos[5].clue = "1";
  if (photos[17]) photos[17].clue = "9";
  photos.forEach((p) => { p.img = new Image(); p.img.src = p.url; });

  const playerImg = new Image();
  playerImg.src = HOUSE_GAME_AVATAR_URL;

  const player = { x: 230, y: 250, r: 28, speed: 260, bob: 0 };
  const camera = { x: 0, y: 0 };
  let nearPhoto = null, running = true, last = performance.now(), elapsed = 0;
  ...
  touchButtons.forEach((btn) => {
    ...
    const pDown = () => { if (dir) keys[dir] = true; };
    const pUp = () => { if (dir) keys[dir] = false; };
    btn.addEventListener("pointerdown", pDown);
    btn.addEventListener("pointerup", pUp);
    btn.addEventListener("pointerleave", pUp);
  });

  const inspectNearby = () => { if (nearPhoto) openInfraInspectModal(nearPhoto); };
  ...
  function update(dt) {
    ...
    if (vx !== 0 || vy !== 0) player.bob += dt * 14;
    camera.x += ((player.x - canvas.width / 2) - camera.x) * 0.08;
    camera.y += ((player.y - canvas.height / 2) - camera.y) * 0.08;
    camera.x = Math.max(0, Math.min(world.width - canvas.width, camera.x));
    camera.y = Math.max(0, Math.min(world.height - canvas.height, camera.y));
    lamps.forEach((l) => { l.flicker = Math.sin(elapsed * (3 + Math.random() * 2)) * 20; });
    dustParticles.forEach((d) => { d.y -= d.speed * dt; d.x += d.drift * dt; if (d.y < -10) { d.y = world.height + 10; d.x = Math.random() * world.width; } });
    nearPhoto = null; let foundCount = 0;
    for (const p of photos) {
      if (p.found) foundCount++;
      const cx = p.x + p.w / 2, cy = p.y + p.h / 2;
      if ((cx - player.x) ** 2 + (cy - player.y) ** 2 < 130 ** 2 && !nearPhoto) { nearPhoto = p; p.found = true; }
    }
    if (counterEl) counterEl.textContent = "\u{1F4F7} " + foundCount + " / " + photos.length;
  }
  ...
  function draw() {
    ...
    ctx.fillStyle = "#0d0f16"; ctx.fillRect(0, 0, world.width, world.height);
    corridors.forEach((c) => { ctx.fillStyle = "#151820"; ctx.fillRect(c.x, c.y, c.w, c.h); });
    rooms.forEach((r) => {
      ctx.fillStyle = r.floor; ctx.fillRect(r.x, r.y, r.w, r.h);
      ctx.strokeStyle = "rgba(255,255,255,0.02)"; ctx.lineWidth = 1;
      for (let tx = r.x; tx < r.x + r.w; tx += 60) { ctx.beginPath(); ctx.moveTo(tx, r.y); ctx.lineTo(tx, r.y + r.h); ctx.stroke(); }
      for (let ty = r.y; ty < r.y + r.h; ty += 60) { ctx.beginPath(); ctx.moveTo(r.x, ty); ctx.lineTo(r.x + r.w, ty); ctx.stroke(); }
      ctx.strokeStyle = "rgba(255,255,255,0.1)"; ctx.lineWidth = 4; ctx.strokeRect(r.x, r.y, r.w, r.h);
      ctx.fillStyle = "rgba(255,255,255,0.12)"; ctx.font = "bold 16px Inter"; ctx.fillText(r.n, r.x + 16, r.y + 24);
    });
    furniture.forEach((f) => {
      if (f.x + f.w < camera.x - 50 || f.x > camera.x + canvas.width + 50 || f.y + f.h < camera.y - 50 || f.y > camera.y + canvas.height + 50) return;
      switch (f.type) {
        case "wardrobe": ctx.fillStyle = "#2a2235"; ctx.fillRect(f.x, f.y, f.w, f.h); ctx.strokeStyle = "rgba(255,255,255,0.08)"; ctx.strokeRect(f.x, f.y, f.w, f.h); ctx.beginPath(); ctx.moveTo(f.x + f.w / 2, f.y + 4); ctx.lineTo(f.x + f.w / 2, f.y + f.h - 4); ctx.strokeStyle = "rgba(255,255,255,0.06)"; ctx.stroke(); ctx.fillStyle = "rgba(200,180,140,0.3)"; ctx.beginPath(); ctx.arc(f.x + f.w / 2 - 8, f.y + f.h / 2, 3, 0, Math.PI * 2); ctx.fill(); ctx.beginPath(); ctx.arc(f.x + f.w / 2 + 8, f.y + f.h / 2, 3, 0, Math.PI * 2); ctx.fill(); break;
        case "table": ctx.fillStyle = "#3a2f22"; ctx.fillRect(f.x, f.y, f.w, f.h); ctx.strokeStyle = "rgba(255,255,255,0.07)"; ctx.strokeRect(f.x, f.y, f.w, f.h); break;
        case "shelf": ctx.fillStyle = "#2d2a35"; ctx.fillRect(f.x, f.y, f.w, f.h); for (let bx = f.x + 4; bx < f.x + f.w - 8; bx += 9) { ctx.fillStyle = "hsl(" + ((bx * 37) % 360) + ", 30%, 22%)"; ctx.fillRect(bx, f.y + 3, 7, f.h - 6); } break;
        case "bed": ctx.fillStyle = "#2b2040"; ctx.fillRect(f.x, f.y, f.w, f.h); ctx.fillStyle = "#382855"; ctx.fillRect(f.x + 5, f.y + 5, f.w * 0.3, f.h - 10); ctx.strokeStyle = "rgba(255,255,255,0.05)"; ctx.strokeRect(f.x, f.y, f.w, f.h); break;
        case "bookshelf": ctx.fillStyle = "#282230"; ctx.fillRect(f.x, f.y, f.w, f.h); for (let sy = f.y + 5; sy < f.y + f.h - 10; sy += 22) { ctx.fillStyle = "rgba(255,255,255,0.03)"; ctx.fillRect(f.x + 2, sy, f.w - 4, 1); for (let bx = f.x + 3; bx < f.x + f.w - 5; bx += 7) { ctx.fillStyle = "hsl(" + ((bx * 53 + sy * 17) % 360) + ", 25%, 20%)"; ctx.fillRect(bx, sy + 2, 5, 16); } } break;
        case "chair": ctx.fillStyle = "#332a3a"; ctx.fillRect(f.x, f.y, f.w, f.h); break;
      }
    });
    lamps.forEach((l) => { ctx.fillStyle = "rgba(255, 200, 80, 0.15)"; ctx.beginPath(); ctx.arc(l.x, l.y, 8, 0, Math.PI * 2); ctx.fill(); ctx.fillStyle = "rgba(255, 220, 120, 0.5)"; ctx.beginPath(); ctx.arc(l.x, l.y, 3, 0, Math.PI * 2); ctx.fill(); });
    photos.forEach((p) => {
      if (p.x + p.w < camera.x - 20 || p.x > camera.x + canvas.width + 20 || p.y + p.h < camera.y - 20 || p.y > camera.y + canvas.height + 20) return;
      p.glowPhase += 0.04;
      if (nearPhoto === p) { const pulseA = 0.5 + Math.sin(p.glowPhase * 3) * 0.3; ctx.strokeStyle = "rgba(255, 210, 80, " + pulseA + ")"; ctx.lineWidth = 4; ctx.shadowBlur = 28; ctx.shadowColor = "rgba(255, 220, 120, " + pulseA + ")"; ctx.strokeRect(p.x - 6, p.y - 6, p.w + 12, p.h + 12); ctx.shadowBlur = 0; } else if (p.found) { ctx.strokeStyle = "rgba(52, 211, 153, 0.3)"; ctx.lineWidth = 2; ctx.strokeRect(p.x - 2, p.y - 2, p.w + 4, p.h + 4); }
      ctx.fillStyle = "#e8e0d8"; ctx.fillRect(p.x, p.y, p.w, p.h);
      if (p.img && p.img.complete) { ctx.drawImage(p.img, p.x + 5, p.y + 5, p.w - 10, p.h - 10); } else { ctx.fillStyle = "#4a4555"; ctx.fillRect(p.x + 5, p.y + 5, p.w - 10, p.h - 10); }
    });
    dustParticles.forEach((d) => { if (d.x < camera.x - 10 || d.x > camera.x + canvas.width + 10 || d.y < camera.y - 10 || d.y > camera.y + canvas.height + 10) return; ctx.fillStyle = "rgba(200, 190, 170, " + d.alpha + ")"; ctx.beginPath(); ctx.arc(d.x, d.y, d.size, 0, Math.PI * 2); ctx.fill(); });
    const bobY = Math.sin(player.bob) * 5;
    const auraGrad = ctx.createRadialGradient(player.x, player.y + bobY, 8, player.x, player.y + bobY, 60);
    auraGrad.addColorStop(0, "rgba(139, 92, 246, 0.18)"); auraGrad.addColorStop(1, "rgba(139, 92, 246, 0)");
    ctx.fillStyle = auraGrad; ctx.beginPath(); ctx.arc(player.x, player.y + bobY, 60, 0, Math.PI * 2); ctx.fill();
    const pw = 54, ph = 68;
    if (playerImg.complete) { ctx.drawImage(playerImg, player.x - pw / 2, player.y - ph / 2 + bobY, pw, ph); } else { ctx.fillStyle = "#a78bfa"; ctx.beginPath(); ctx.arc(player.x, player.y + bobY, player.r * 0.7, 0, Math.PI * 2); ctx.fill(); }
    ctx.restore();

    ctx.fillStyle = "rgba(0,0,0,0.82)"; ctx.fillRect(0, 0, canvas.width, canvas.height);
    ctx.globalCompositeOperation = "destination-out";
    const carveLight = (x, y, r, int) => { const g = ctx.createRadialGradient(x, y, 6, x, y, r); g.addColorStop(0, "rgba(0,0,0," + (int || 0.95) + ")"); g.addColorStop(0.6, "rgba(0,0,0," + ((int || 0.95) * 0.4) + ")"); g.addColorStop(1, "rgba(0,0,0,0)"); ctx.fillStyle = g; ctx.beginPath(); ctx.arc(x, y, r, 0, Math.PI * 2); ctx.fill(); };
    lamps.forEach((l) => carveLight(l.x - camera.x, l.y - camera.y, l.r + l.flicker, 0.9));
    carveLight(player.x - camera.x, player.y - camera.y + Math.sin(player.bob) * 5, 155, 0.95);
    ctx.globalCompositeOperation = "source-over";
    const vigGrad = ctx.createRadialGradient(canvas.width / 2, canvas.height / 2, canvas.width * 0.25, canvas.width / 2, canvas.height / 2, canvas.width * 0.7);
    vigGrad.addColorStop(0, "rgba(0,0,0,0)"); vigGrad.addColorStop(1, "rgba(20,0,5,0.35)");
    ctx.fillStyle = vigGrad; ctx.fillRect(0, 0, canvas.width, canvas.height);

    const mapW = 170, mapH = 120, mapX = canvas.width - mapW - 12, mapY = 12;
    ctx.fillStyle = "rgba(8,8,14,0.82)"; ctx.fillRect(mapX, mapY, mapW, mapH);
    ctx.strokeStyle = "rgba(139,92,246,0.25)"; ctx.lineWidth = 1; ctx.strokeRect(mapX, mapY, mapW, mapH);
    const sx = mapW / world.width, sy = mapH / world.height;
    rooms.forEach((r) => { ctx.fillStyle = "rgba(30,30,50,0.6)"; ctx.fillRect(mapX + r.x * sx, mapY + r.y * sy, r.w * sx, r.h * sy); ctx.strokeStyle = "rgba(255,255,255,0.15)"; ctx.lineWidth = 0.5; ctx.strokeRect(mapX + r.x * sx, mapY + r.y * sy, r.w * sx, r.h * sy); });
    photos.forEach((p) => { ctx.fillStyle = p.found ? "#34d399" : "rgba(100,100,120,0.5)"; ctx.fillRect(mapX + p.x * sx, mapY + p.y * sy, 3, 2.5); });
    ctx.fillStyle = "#a78bfa"; ctx.beginPath(); ctx.arc(mapX + player.x * sx, mapY + player.y * sy, 3.5, 0, Math.PI * 2); ctx.fill();
    ctx.fillStyle = "rgba(255,255,255,0.35)"; ctx.font = "9px Inter"; ctx.fillText("MAPA", mapX + 5, mapY + mapH - 4);
    if (nearPhoto) { ctx.fillStyle = "rgba(0,0,0,0.65)"; const tw = 340; ctx.fillRect(canvas.width / 2 - tw / 2, canvas.height - 44, tw, 32); ctx.fillStyle = "rgba(255, 210, 80, 0.95)"; ctx.font = "bold 13px Inter"; ctx.textAlign = "center"; ctx.fillText("\u{1F4F8} Foto encontrada \u2014 toca para inspeccionar", canvas.width / 2, canvas.height - 24); ctx.textAlign = "start"; }
  }

  function loop(now) { if (!running) return; const dt = Math.min(0.033, (now - last) / 1000); last = now; update(dt); draw(); requestAnimationFrame(loop); }
  ...
  function openInfraInspectModal(photo) {
    ...
    modal.innerHTML = '<div class="infra-photo-modal__backdrop"></div><div class="infra-photo-modal__content"><div class="infra-photo-modal__header"><span class="infra-photo-modal__icon">\u{1F526}</span><h4>Esc\u00E1ner Infrarrojo</h4></div><p class="infra-photo-modal__hint">Mueve la linterna lentamente para buscar un n\u00FAmero oculto en la foto.</p><div class="infra-photo-modal__canvas-wrap"><canvas width="720" height="460" class="infra-photo-canvas"></canvas></div><button class="infra-photo-close">\u2715 Cerrar esc\u00E1ner</button></div>';
    ...
    const cluePos = { x: 80 + Math.random() * (mCanvas.width - 200), y: 100 + Math.random() * (mCanvas.height - 200) };
    let irRunning = true, scanLineOffset = 0;
    const handleMove = (ev) => { ev.preventDefault(); const rect = mCanvas.getBoundingClientRect(); const t = ev.touches ? ev.touches[0] : ev; pointer.x = ((t.clientX - rect.left) / rect.width) * mCanvas.width; pointer.y = ((t.clientY - rect.top) / rect.height) * mCanvas.height; };
    mCanvas.addEventListener("mousemove", handleMove);
    mCanvas.addEventListener("touchmove", handleMove, { passive: false });
    const closeModal = () => { irRunning = false; modal.classList.remove("is-open"); setTimeout(() => modal.remove(), 320); };
    closeBtn?.addEventListener("click", closeModal);
    backdrop?.addEventListener("click", closeModal);
    function renderIR() {
      if (!irRunning) return;
      scanLineOffset = (scanLineOffset + 0.5) % 4;
      mCtx.fillStyle = "#050608"; mCtx.fillRect(0, 0, mCanvas.width, mCanvas.height);
      if (img.complete) mCtx.drawImage(img, 0, 0, mCanvas.width, mCanvas.height);
      if (photo.clue) { mCtx.save(); mCtx.font = "bold 120px 'Inter', sans-serif"; mCtx.fillStyle = "rgba(255, 40, 60, 0.5)"; mCtx.shadowBlur = 20; mCtx.shadowColor = "rgba(255, 0, 0, 0.4)"; mCtx.fillText(photo.clue, cluePos.x, cluePos.y); mCtx.restore(); }
      mCtx.fillStyle = "rgba(0,0,0,0.94)"; mCtx.fillRect(0, 0, mCanvas.width, mCanvas.height);
      mCtx.globalCompositeOperation = "destination-out";
      const beamR = 110; const rg = mCtx.createRadialGradient(pointer.x, pointer.y, 12, pointer.x, pointer.y, beamR); rg.addColorStop(0, "rgba(0,0,0,1)"); rg.addColorStop(0.7, "rgba(0,0,0,0.6)"); rg.addColorStop(1, "rgba(0,0,0,0)"); mCtx.fillStyle = rg; mCtx.beginPath(); mCtx.arc(pointer.x, pointer.y, beamR, 0, Math.PI * 2); mCtx.fill();
      mCtx.globalCompositeOperation = "source-over";
      const redGlow = mCtx.createRadialGradient(pointer.x, pointer.y, 10, pointer.x, pointer.y, beamR + 30); redGlow.addColorStop(0, "rgba(180, 30, 30, 0.08)"); redGlow.addColorStop(0.5, "rgba(120, 10, 10, 0.06)"); redGlow.addColorStop(1, "rgba(0,0,0,0)"); mCtx.fillStyle = redGlow; mCtx.beginPath(); mCtx.arc(pointer.x, pointer.y, beamR + 30, 0, Math.PI * 2); mCtx.fill();
      mCtx.fillStyle = "rgba(0,0,0,0.06)"; for (let y = scanLineOffset; y < mCanvas.height; y += 4) mCtx.fillRect(0, y, mCanvas.width, 1);
      const vig = mCtx.createRadialGradient(mCanvas.width / 2, mCanvas.height / 2, mCanvas.width * 0.2, mCanvas.width / 2, mCanvas.height / 2, mCanvas.width * 0.6); vig.addColorStop(0, "rgba(0,0,0,0)"); vig.addColorStop(1, "rgba(0,0,0,0.3)"); mCtx.fillStyle = vig; mCtx.fillRect(0, 0, mCanvas.width, mCanvas.height);
  ...
  window.__houseGame26Cleanup = () => {
    ...
    window.removeEventListener("resize", _hgResize);
  };
}
...
function renderGameMemory(container, memory) {
  ...
  function spawnObstacle() {
    ...
    gObstacles.push({
      ...
      w: 32,
      hTop: topH,
      hBottom: canvas.height - topH - gap,
      passed: false,
    });
  }
  ...
  function animate() {
    ...
    gPlayer.vy += gravityNow;
    gPlayer.y += gPlayer.vy;
    if (gPlayer.y + gPlayer.r >= canvas.height) {
      gPlayer.y = canvas.height - gPlayer.r;
      gPlayer.vy = 0;
    }
    if (gPlayer.y - gPlayer.r <= 0) {
      gPlayer.y = gPlayer.r;
      gPlayer.vy = 0;
    }
    gameSpeed =
      (BASE_SPEED + Math.min(score * 0.08, 1.5)) *
      (speedBoostActive ? 1.65 : 1);

    // Spawners
    if (gOpts.obstacleTimer-- <= 0) {
      spawnObstacle();
      gOpts.obstacleTimer = Math.max(90, 150 - score * 5);
    }
    if (gOpts.coinTimer-- <= 0) {
      spawnCoin();
      gOpts.coinTimer = 40 + Math.random() * 50;
    }
    if (frameCount % 280 === 0) spawnPowerup();

    // Draw obstacles
    for (let i = gObstacles.length - 1; i >= 0; i--) {
      const obs = gObstacles[i];
      obs.x -= gameSpeed;
      const tGrad = ctx.createLinearGradient(obs.x, 0, obs.x + obs.w, 0);
      tGrad.addColorStop(0, "rgba(139,92,246,0.35)");
      tGrad.addColorStop(0.5, "rgba(139,92,246,0.5)");
      tGrad.addColorStop(1, "rgba(139,92,246,0.35)");
      ctx.fillStyle = tGrad;
      ctx.fillRect(obs.x, 0, obs.w, obs.hTop);
      ctx.fillStyle = "rgba(139,92,246,0.6)";
      ctx.fillRect(obs.x - 3, obs.hTop - 8, obs.w + 6, 8);
      ctx.fillStyle = tGrad;
      const bY = canvas.height - obs.hBottom;
      ctx.fillRect(obs.x, bY, obs.w, obs.hBottom);
      ctx.fillStyle = "rgba(139,92,246,0.6)";
      ctx.fillRect(obs.x - 3, bY, obs.w + 6, 8);
      ctx.strokeStyle = "rgba(139,92,246,0.3)";
      ctx.lineWidth = 1;
      ctx.strokeRect(obs.x, 0, obs.w, obs.hTop);
      ctx.strokeRect(obs.x, bY, obs.w, obs.hBottom);

      const pad = 6;
      const pL = gPlayer.x - gPlayer.r + pad,
        pR = gPlayer.x + gPlayer.r - pad;
      const pT = gPlayer.y - gPlayer.r + pad,
        pB = gPlayer.y + gPlayer.r - pad;
      if (pR > obs.x && pL < obs.x + obs.w && pT < obs.hTop) {
        doGameOver();
        return;
      }
      if (pR > obs.x && pL < obs.x + obs.w && pB > bY) {
        doGameOver();
        return;
      }
      if (!obs.passed && obs.x + obs.w < gPlayer.x) {
        obs.passed = true;
        score++;
      }
    ...
    for (let i = coinsArray.length - 1; i >= 0; i--) {
      ...
      if (!coin.collected) {
        ...
        ctx.shadowBlur = 15;
        ctx.shadowColor =
          "rgba(251,191,36," + (0.3 + Math.sin(coin.glow) * 0.2) + ")";
        ctx.beginPath();
      ...
      const dx = gPlayer.x - coin.x,
        dy = gPlayer.y - coin.y;
      if (
        !coin.collected &&
        dx * dx + dy * dy < (gPlayer.r + coin.hitR) * (gPlayer.r + coin.hitR)
      ) {
        coin.collected = true;
        gameCoins++;
        updateCoinDisplay();
        localStorage.setItem("minigame_coins", gameCoins);
        addGParticle(coin.x, coin.y, "#fbbf24", 8);
      }
    ...
    gPlayer.trail.forEach((t, i) => {
      ...
      ctx.arc(
        t.x,
        t.y,
        gPlayer.r * (i / gPlayer.trail.length) * 0.6,
        0,
        Math.PI * 2,
      );
    ...
    ctx.beginPath();
    ctx.arc(gPlayer.x, gPlayer.y, gPlayer.r, 0, Math.PI * 2);
    ...
    ctx.restore();
    ctx.beginPath();
    ctx.arc(gPlayer.x - 4, gPlayer.y - 4, 4, 0, Math.PI * 2);
    ctx.fillStyle = "rgba(255,255,255,0.5)";
    ctx.fill();
    ctx.font = gPlayer.r + "px sans-serif";
    ctx.textAlign = "center";
    ctx.textBaseline = "middle";
...
window.shopItemClick = function (id) {
  ...
  if (unlockedShopItems.includes(id)) {
    ...
    // Locked -> Confirm Buy
    try {
      openShopDetailsModal(item);
    } catch (e) {
      console.error("Open details error:", e);
    }
  }
};

window.shopItemClickDebug = function () {
  alert("Click handler is active");
};
...
window.confirmBuy = function (id) {
  ...
  if (gameCoins >= item.price) {
    ...
    localStorage.setItem(
      "minigame_unlocked_items",
      JSON.stringify(unlockedShopItems),
    );
...
window.buyItem = function (id, price) {
  if (gameCoins >= price) {
    ...
    alertBox.style.cssText =
      "position: absolute; bottom: 20px; left: 50%; transform: translateX(-50%); background: #ef4444; color: white; padding: 10px 20px; border-radius: 20px; animation: fadeOut 3s forwards;";
  ...
  if (item) {
    openGalleryLightbox({
      ...
      text:
        item.type === "card"
          ? item.codeDigit
            ? `✅ Esta tarjeta sí tiene una pista. Número: ${item.codeDigit}`
            : item.text || "en esta no hay nada, sigue probando"
...
function showShopReveal(id) {
  ...
  setTimeout(() => {
    ...
    imgWrap.style.boxShadow =
      "0 0 60px rgba(123,92,255,0.6), 0 0 120px rgba(123,92,255,0.2)";
  }, 3200);
...
const BOOK_COVER_IMAGE =
  "https://res.cloudinary.com/dbbdcxcvx/image/upload/v1771402597/IMG-20250816-WA0018_bt7e1o.jpg";
...
function saveBookmarks(b) {
  localStorage.setItem("book_bookmarks", JSON.stringify(b));
}
function getLastBookPage() {
  return parseInt(localStorage.getItem("book_last_page") || "0");
}
function saveLastBookPage(p) {
  localStorage.setItem("book_last_page", String(p));
}
...
function buildBookPages() {
  ...
  BOOK_CHAPTERS.forEach((chapter, idx) => {
    ...
    const rawText =
      idx === 0 ? injectBookSecretClues(chapter.content) : chapter.content;
    ...
    for (const sentence of sentences) {
      if (
        currentPara.length + sentence.length > 250 &&
        currentPara.length > 60
      ) {
...
function openBookOverlay() {
  ...
  function renderPage(pageIdx, direction, skipFlip) {
    ...
    const doRender = () => {
      ...
      nextBtn.style.visibility =
        pageIdx === pages.length - 1 ? "hidden" : "visible";
      showNav();
      renderTabs();
    };
  ...
  overlay.addEventListener("click", (e) => {
    if (
      e.target === pageWrapper ||
      e.target.closest(
        ".book-page-content,.book-cover,.book-chapter-title,.book-end-page",
      )
    ) {
  ...
  overlay
    .querySelector(".book-overlay__backdrop")
...
function playBook2Intro(onComplete) {
  ...
  for (let i = 0; i < 50; i++) {
    particles.push({
      ...
      color: ["#e8a0bf", "#c77dba", "#9b59b6", "#d4a5a5", "#f5c6d0"][
...
function openBook2Overlay() {
  ...
  if (ch1Skipped) {
    ...
    pages = pages.filter((p) => {
      if (
        (p.type === "chapter-title" || p.type === "content") &&
        p.chapterIndex === 0
      )
        return false;
      return true;
  ...
  function getBook2Bookmarks() {
    try {
      return JSON.parse(localStorage.getItem("book2_bookmarks") || "[]");
    } catch (e) {
      return [];
    }
  }
  function saveBook2Bookmarks(b) {
    localStorage.setItem("book2_bookmarks", JSON.stringify(b));
  }
  ...
  overlay.addEventListener("click", (e) => {
    if (
      e.target === pageWrapper ||
      e.target.closest(
        ".book2-page-content,.book2-cover,.book2-chapter-title,.book2-end-page,.book2-intro-page",
      )
    ) {
      if (!navVisible) showNav();
    }
  ...
  overlay
    .querySelector(".book2-overlay__backdrop")
    .addEventListener("click", closeBook2);
  ...
  MEMORIES.forEach((memory) => {
    ...
    if (isWindowOpen) {
      ...
      if (now < entry.ts) {
        ...
        if (hours > 0 || days > 0)
          timeString += `<span class="time-val">${hours}h</span> `;
...
function getFirstMemoryElement(suffix) {
  return (
    document.getElementById("start-memory-" + suffix) ||
    document.getElementById("first-memory-" + suffix)
  );
}

function showFirstMemoryCeremony() {
  const overlay =
    document.getElementById("start-memory-modal") ||
    document.getElementById("first-memory-overlay");
  const img =
    getFirstMemoryElement("image") ||
    document.getElementById("first-memory-img");
  const textBox =
    getFirstMemoryElement("text") ||
    document.getElementById("first-memory-text-box");
  const closeBtn = getFirstMemoryElement("close");
  const card = overlay
    ? overlay.querySelector(".start-memory-card, .first-memory-content")
    : null;
  ...
  // Open Overlay
  overlay.classList.add("active");
  if (overlay.classList.contains("first-memory-overlay"))
  ...
  if (nCanvas) {
    ...
    function animateNostalgiaParticles() {
      ...
      for (const p of nParticles) {
        ...
        p.y += p.speedY;
        if (p.y < -10) {
          p.y = nCanvas.height + 10;
          p.x = Math.random() * nCanvas.width;
        }
...
function closeFirstMemory() {
  ...
  const card = document.querySelector(
    '.memory-card[data-date="' + MEMORIES[0].date + '"]',
  );
  if (card) {
    card.classList.add("is-unlocked");
...
function updateCountdownPrecise() {
  ...
  const openEntry = UNLOCK_TIMESTAMPS.find(
    (e) =>
      e.ts > 0 && !isUnlockedInStorage(e.date) && isUnlockWindowOpen(e.date),
  );
  if (openEntry) {
  ...
  const dateLabel = nextDate.toLocaleDateString("es-ES", {
    day: "numeric",
    month: "short",
  });
